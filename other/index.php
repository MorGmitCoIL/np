...
///////////////////////////////////////////////////////////////////////////////////////////////////
// <owncloud directory>/apps/files/index.php changes, 5/3/2013
// if user is not some sort of admin, change the initial directory to /Shared
//TODO if user is not group admin then $dir = startsWith('/Shared', $dir) ? $dir : '/Shared'.$dir;
//TODO possibly move this to a hook, maybe changing the GET variable 'dir'
